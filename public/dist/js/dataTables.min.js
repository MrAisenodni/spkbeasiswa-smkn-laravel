...
iStateDuration:7200,iDeferLoading:null,iDisplayLength:10,iDisplayStart:0,iTabIndex:0,oClasses:{},oLanguage:{oAria:{sSortAscending:": activate to sort column ascending",sSortDescending:": activate to sort column descending"},oPaginate:{sFirst:"Utama",sLast:"Last",sNext:"Lanjut",sPrevious:"Sebelum"},sEmptyTable:"No data available in table",sInfo:"Tampil _START_ sampai _END_ dari _TOTAL_ data",sInfoEmpty:"Tampil 0 sampai 0 dari 0 data",sInfoFiltered:"(tersaring dari _MAX_ total data)",sInfoPostFix:"",sDecimal:"",
sThousands:",",sLengthMenu:"Tampil _MENU_ data",sLoadingRecords:"Loading...",sProcessing:"Processing...",sSearch:"Cari:",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"Tidak ada data yang ditemukan"},oSearch:k.extend({},u.models.oSearch),sAjaxDataProp:"data",sAjaxSource:null,sDom:"lfrtip",searchDelay:null,sPaginationType:"simple_numbers",sScrollX:"",sScrollXInner:"",sScrollY:"",sServerMethod:"GET",renderer:null,rowId:"DT_RowId"};G(u.defaults);u.defaults.column={aDataSort:null,iDataSort:-1,asSorting:["asc",

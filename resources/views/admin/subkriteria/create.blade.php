        ...
        <div class="container-fluid center">
            <div class="row">
                <div class="col-md-12 bg-white">
                    <form method="POST" class="p-2 mb-2" action="/admin/subkriteria">
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('nama_subkriteria') is-invalid @enderror" id="nama_subkriteria" name="nama_subkriteria" value="{{ old('nama_subkriteria') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('bobot_subkriteria') is-invalid @enderror" id="bobot_subkriteria" name="bobot_subkriteria" value="{{ old('bobot_subkriteria') }}">
